...
$store_sql_password = 'db';
$loggingdir = dirname(__DIR__) . '/log';
if (!file_exists($loggingdir)) {
  mkdir($loggingdir);
}

// Locations of the certs dir.
$certdir = dirname(__DIR__) . '/cert';
$metadatadir = dirname(__DIR__) . '/metadata-generated';
...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://' . $_SERVER['VIRTUAL_HOST'] . '/simplesaml/',
    ...
    'application' => [
         ...
         */
        'baseURL' => 'https://orange.ddev.site',
    ],
    ...
    */
     ...
     */
    'secretsalt' => 'd311h7ln9v1soze32sz5jiqmrltfrhqw',
     ...
     */
    'trusted.url.domains' => ['orange.ddev.site'],
